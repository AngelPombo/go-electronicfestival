  ...
  return (
    <section className='taquilla-section'>
      <div className='div-video-taquilla'>
        <video src={video} preload="auto" autoPlay muted loop playsInline className='video-taquilla'></video>
      </div>
