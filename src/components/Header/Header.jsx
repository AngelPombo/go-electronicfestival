        ...
        <header className={"header"}>
            ...
            <menu className="menu-header">
                <ul className={clicked ? "ul-header on" : "ul-header off"} id='menu'>
                    <li className={clicked ? "header-li" : ""}><Link to={'/'} className="nav-link"><button onClick={handleClick}>INICIO</button></Link></li>
                    <li className={clicked ? "header-li" : ""}><Link to={'/taquilla'} className="nav-link"><button onClick={handleClick}>TAQUILLA</button></Link></li>
                    <li className={clicked ? "header-li" : ""}><Link to={'/autobuses-oficiales'} className="nav-link"><button onClick={handleClick}>AUTOBUSES</button></Link></li>
